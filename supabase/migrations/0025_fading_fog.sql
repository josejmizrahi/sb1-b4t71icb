/*
  # Fix Messaging System Migration

  1. Changes
    - Drop and recreate messaging tables with proper structure
    - Fix RLS policies to prevent recursion
    - Add proper indexes for performance
    - Fix function parameter naming conflicts
...
-- Function to get unread message count with renamed parameter
